...
criterio.Hurwicz.General = function(tablaX,alfa=0.3,favorable=TRUE) {
  ...
  #En algún punto de alfa(dependiendo de nuestro problema), ocurrira que la 
  ...
  #beneficios
  X = tablaX;
  if (favorable) {#En el caso de que estemos trabajando con la matriz de 
    #beneficios, que indicamos si hemos puesto favorable =T
    ...
    for (i in 1:length(valfa)) {
      ...
      #Con ValtH, tenemos la función de Hurwicz, alfa le da peso al criterio 
      #optimista
    ...
    metodo = 'favorable';
  } else {#Hacemos algo similar pero ahora tenid
...
Al aplicar la función de criterio.Hurwicz.General a nuestro problema y indicarle si queremos el alfa deseado,nos devolverá la tabla del problema que le hemos indicado, el valor de las alternativas con la función de Hurwicz, el valor y la alternativa optima. 
