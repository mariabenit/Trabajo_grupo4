...
```{r}
criterio.Wald = function(tablaX,favorable=TRUE) { ## primero aplicamos el criterio
                                                  ## suponiendo que los pagos son ganancias,
                                                  ## es decir, buscando el mínimo de los
                                                  ## máximos (maximin)
  X = tablaX;
  if (favorable) {
  ...
  } else {            ## ahora suponemos que los pagos son costes, buscamos
                      ## el máximo de los mínimos (minimax)
