...
En este criterio se combinan las aptitudes pesimistas y optimistas, valorando  cada alternativa con una ponderación entre lo mejor y lo peor posible, que denominamos alfa(índice de optimismo). 
...
criterio.Hurwicz.General = function(tablaX,alfa=0.3,favorable=TRUE) {
  ...
  if (favorable) {
    ...
    for (i in 1:length(valfa)) {
      ...
      #Con ValtH, tenemos la función de Hurwicz
